...
// v3 был раздел «Бренд», ОТКАЧЁН по решению Едыге; версия поднята до v4, а не возвращена
// к v2, чтобы у того, кто успел открыть v3, кэш гарантированно перекачался.
